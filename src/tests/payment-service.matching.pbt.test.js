...
describe('Property 14: Matching within tolerance, otherwise ignored', () => {
  ...
  it('a payin tx settles iff it is within tolerance, otherwise it is ignored', () => {
    fc.assert(
      fc.property(
        ...
        (amount, tolerance, within, magnitude, negative, settleOffset) => {
          ...
          const payment = service.createPayment({ mode: 'client', amount, tolerance });
